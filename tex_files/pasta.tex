...
\end{equation}
then $\pi(n)$ is the long-run fraction of jobs that observe $n$ customers in the system at the moment of arrival.
...
\begin{exercise}\clabel{ex:l-152}
 Check that~\cref{eq:13} holds for the system of 2.4.1.
\begin{solution}
