...
\end{equation*}
as the number of jobs up to time $t$ that see $m$ in the system upon arrival and have batch size larger than $n-m$. We will use the survivor function G(x) to indicate the probability that a batch has a size greater than x.
